<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="reportList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="举报标题" align="center" prop="title" />
      <el-table-column label="举报内容" align="center" prop="contentText" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="举报内容" prop="contentText">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除用户举报编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有用户举报数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(() => {
