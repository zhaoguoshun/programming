    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['system:slideshow:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['system:slideshow:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['system:slideshow:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
<script>
import { listSlideshow, getSlideshow, delSlideshow, addSlideshow, updateSlideshow, exportSlideshow } from "@/api/system/slideshow";
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      ...
      this.form.imgUrl = 'http://localhost:8083'+res.imgUrl
    },
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有轮播图数据项?', "警告", {
        ...
        return exportSlideshow(queryParams);
      }).then(response => {
